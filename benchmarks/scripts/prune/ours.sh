python prune_cifar.py --mode prune --model resnet56 --batch_size 128 --restore run/pretrain/cifar100_resnet56.pth --pruning_steps 1 --sparsity 0.24 --dataset cifar100  --method ours  # 40
python prune_cifar.py --mode prune --model resnet56 --batch_size 128 --restore run/pretrain/cifar100_resnet56.pth --pruning_steps 1 --sparsity 0.35 --dataset cifar100  --method ours  # 60
python prune_cifar.py --mode prune --model resnet56 --batch_size 128 --restore run/pretrain/cifar100_resnet56.pth --pruning_steps 1 --sparsity 0.6 --dataset cifar100  --method ours   # 80
python prune_cifar.py --mode prune --model resnet56 --batch_size 128 --restore run/pretrain/cifar100_resnet56.pth --pruning_steps 1 --sparsity 0.8 --dataset cifar100  --method ours   # 90
