...
Latency test on ResNet-50, Batch Size=64. Please refer to the [benchmark](https://github.com/VainF/Torch-Pruning/blob/master/benchmarks/readme.md#4-latency-test-resnet-50-batch-size-64) for more detials.
