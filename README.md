...
pruning_index = strategy(model.conv1.weight, amount=0.4) # or manually selected [0, 2, 6]
pruning_plan = DG.get_pruning_plan( model.conv1, pruning.prune_conv, idxs=pruning_index )
print(pruning_plan)
