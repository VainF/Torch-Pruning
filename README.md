...
### Updates:
**3/24/2022** A new version is available in branch [v1.0](https://github.com/VainF/Torch-Pruning/tree/v1.0), which supports Vision Transformers, Group Convolutions, etc.
