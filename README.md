...
* **Reproducible [Performance Benchmark](benchmarks) and [Prunability Benchmarks](benchmarks/prunability):** Currently, TP is able to prune approximately **77/85=90.6%** of the models from Torchvision 0.13.1. Check out [practical_structural_pruning.md](practical_structural_pruning.md) for an up-to-date list for practical pruning techniques. 
